...
namespace bt_captcha
{
    class Captcha
    {
        ...
        Bitmap bmp = null;
        Bitmap bmpBW = null;
        Bitmap bmpClean = null;
        Bitmap bmpSmooth = null;

        public Bitmap getClean() { return bmpClean; }
        public Bitmap getBW() { return bmpBW; }
        public Bitmap getSmooth() { return bmpSmooth; }
        ...
        private bool loadData(string file)
        {
            try
            {
                ...
                string[] tmpStats = tr.ReadLine().Split(' ');
                for (int x = 0; x < 10; x++)
        ...
        private void isolateChars()
        {
            ...
            for (int y = 0; y < 50; y++)
            {
                for (int x = 0; x < 200; x++)
                {
                    ...
                    {
                        if (isNoise(new Bitmap(bmp), new Point(x, y), 30))
